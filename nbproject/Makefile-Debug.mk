...
${OBJECTDIR}/Tokens/NumberToken.o: Tokens/NumberToken.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tokens/NumberToken.o Tokens/NumberToken.cpp

${OBJECTDIR}/Tokens/StringToken.o: Tokens/StringToken.cpp 
	${MKDIR} -p ${OBJECTDIR}/Tokens
	${RM} "$@.d"
	$(COMPILE.cc) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tokens/StringToken.o Tokens/StringToken.cpp

${OBJECTDIR}/Tokens/Token.o: Tokens/Token.cpp 
	${MKDIR} -p ${OBJECTDIR}/Tokens
	${RM} "$@.d"
	$(COMPILE.cc) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tokens/Token.o Tokens/Token.cpp

${OBJECTDIR}/Tokens/Tokenizer.o: Tokens/Tokenizer.cpp 
	${MKDIR} -p ${OBJECTDIR}/Tokens
	${RM} "$@.d"
	$(COMPILE.cc) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tokens/Tokenizer.o Tokens/Tokenizer.cpp

${OBJECTDIR}/Values/JSONArray.o: Values/JSONArray.cpp 
	${MKDIR} -p ${OBJECTDIR}/Values
	${RM} "$@.d"
	$(COMPILE.cc) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Values/JSONArray.o Values/JSONArray.cpp

${OBJECTDIR}/Values/JSONBool.o: Values/JSONBool.cpp 
	${MKDIR} -p ${OBJECTDIR}/Values
	${RM} "$@.d"
	$(COMPILE.cc) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Values/JSONBool.o Values/JSONBool.cpp

${OBJECTDIR}/Values/JSONNull.o: Values/JSONNull.cpp 
	${MKDIR} -p ${OBJECTDIR}/Values
	${RM} "$@.d"
	$(COMPILE.cc) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Values/JSONNull.o Values/JSONNull.cpp

${OBJECTDIR}/Values/JSONNumber.o: Values/JSONNumber.cpp 
	${MKDIR} -p ${OBJECTDIR}/Values
	${RM} "$@.d"
	$(COMPILE.cc) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Values/JSONNumber.o Values/JSONNumber.cpp

${OBJECTDIR}/Values/JSONObject.o: Values/JSONObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/Values
	${RM} "$@.d"
	$(COMPILE.cc) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Values/JSONObject.o Values/JSONObject.cpp

${OBJECTDIR}/Values/JSONString.o: Values/JSONString.cpp 
	${MKDIR} -p ${OBJECTDIR}/Values
	${RM} "$@.d"
	$(COMPILE.cc) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Values/JSONString.o Values/JSONString.cpp

${OBJECTDIR}/Values/JSONValue.o: Values/JSONValue.cpp 
	${MKDIR} -p ${OBJECTDIR}/Values
	${RM} "$@.d"
	$(COMPILE.cc) -g  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Values/JSONValue.o Values/JSONValue.cpp
...
${TESTDIR}/tests/TokenizerTestRunner.o: tests/TokenizerTestRunner.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TokenizerTestRunner.o tests/TokenizerTestRunner.cpp


${TESTDIR}/tests/TokenizerTester.o: tests/TokenizerTester.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TokenizerTester.o tests/TokenizerTester.cpp
...
${OBJECTDIR}/Tokens/NumberToken_nomain.o: ${OBJECTDIR}/Tokens/NumberToken.o Tokens/NumberToken.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tokens/NumberToken_nomain.o Tokens/NumberToken.cpp;\
	else  \
...
${OBJECTDIR}/Tokens/StringToken_nomain.o: ${OBJECTDIR}/Tokens/StringToken.o Tokens/StringToken.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tokens/StringToken_nomain.o Tokens/StringToken.cpp;\
	else  \
...
${OBJECTDIR}/Tokens/Token_nomain.o: ${OBJECTDIR}/Tokens/Token.o Tokens/Token.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tokens/Token_nomain.o Tokens/Token.cpp;\
	else  \
...
${OBJECTDIR}/Tokens/Tokenizer_nomain.o: ${OBJECTDIR}/Tokens/Tokenizer.o Tokens/Tokenizer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tokens/Tokenizer_nomain.o Tokens/Tokenizer.cpp;\
	else  \
...
${OBJECTDIR}/Values/JSONArray_nomain.o: ${OBJECTDIR}/Values/JSONArray.o Values/JSONArray.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Values/JSONArray_nomain.o Values/JSONArray.cpp;\
	else  \
...
${OBJECTDIR}/Values/JSONBool_nomain.o: ${OBJECTDIR}/Values/JSONBool.o Values/JSONBool.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Values/JSONBool_nomain.o Values/JSONBool.cpp;\
	else  \
...
${OBJECTDIR}/Values/JSONNull_nomain.o: ${OBJECTDIR}/Values/JSONNull.o Values/JSONNull.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Values/JSONNull_nomain.o Values/JSONNull.cpp;\
	else  \
...
${OBJECTDIR}/Values/JSONNumber_nomain.o: ${OBJECTDIR}/Values/JSONNumber.o Values/JSONNumber.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Values/JSONNumber_nomain.o Values/JSONNumber.cpp;\
	else  \
...
${OBJECTDIR}/Values/JSONObject_nomain.o: ${OBJECTDIR}/Values/JSONObject.o Values/JSONObject.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Values/JSONObject_nomain.o Values/JSONObject.cpp;\
	else  \
...
${OBJECTDIR}/Values/JSONString_nomain.o: ${OBJECTDIR}/Values/JSONString.o Values/JSONString.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Values/JSONString_nomain.o Values/JSONString.cpp;\
	else  \
...
${OBJECTDIR}/Values/JSONValue_nomain.o: ${OBJECTDIR}/Values/JSONValue.o Values/JSONValue.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Values/JSONValue_nomain.o Values/JSONValue.cpp;\
	else  \
